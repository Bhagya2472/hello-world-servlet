...
// for display purposes
      ...
      git 'https://github.com/Bhagya2472/hello-world-servlet.git'
...
post {
        success {
            mail to:"bhagyalaxmip2472@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"bhagyalaxmip2472@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
